		...
		<div
			...
			<section class="text-gray-900 body-font">
				<div
					...
					<div class="row w-100">
						<div
							class="col-lg-6 col-md-6 col-12 d-flex justify-content-start align-items-start">
							<div class="text-left">
								...
								<br> <img src="imagenes/fondo2.jpg" alt="Bienvenida"
									class="object-cover object-left rounded"
									style="display: block; margin: 0; min-width: 250px; min-heigt: 360px; max-width: 340px; max-height: 380px;">
							</div>
						</div>

						<div
							class="col-lg-6 col-md-6 col-12 d-flex justify-content-center align-items-center"
							...
							<div class="rounded-lg p-4 text-center">
								...
								<p class="text-xs text-gray-700 mt-3">No compartas ningun
									dato personal. Nadie del banco lo va a solicitar.</p>
							</div>
						</div>
					</div>
				</div>
